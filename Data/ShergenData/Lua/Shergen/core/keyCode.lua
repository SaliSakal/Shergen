  -- KeyCodes for OnKeyDown, OnKeyUp and GUI.IsKeyPressed.    Same like enum Sikl.Net.Input.Key.
  Key =
    {
        -- An unknown key.
        Unknown = -1,
        ...
        -- Non US keyboard layout key 1. non-US #1 
        World1 = 161,

        -- Non US keyboard layout key 2. non-US #2
        World2 = 162,
  ...
  -- ButtonCode and GUI.IsMousePressed.    Same like enum Sikl.Net.Input.MouseButton.
MouseButton =
    {
